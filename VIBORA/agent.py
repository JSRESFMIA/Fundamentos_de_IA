...
class Agent:
    ...
    def __init__(self):
        ...
        self.memory = deque(maxlen=MAX_MEMORY)  # pila finita con popleft()
    ...
    def remember(self, state, action, reward, next_state, done):
        self.memory.append((state, action, reward, next_state, done))  # popleft si se alcanza la MAX_MEMORY
